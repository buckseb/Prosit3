...
public class Main {
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            System.out.println("5. Compare zoos");
            ...
            switch (choice) {
                ...
                case 5:
                    Zoo anotherZoo = new Zoo("Another Zoo", "OtherCity",50);
                    Zoo result = Zoo.comparerZoo(myZoo, anotherZoo);
                    System.out.println("The zoo with more animals is: " + result.toString());
                    break;
